...
class LA_TEA():
    ...
    def __init__(self):
        ...
        self.inventory_calc_done=False #this means inventory calculation has not been done yet.
    ...
    def interm_calc(self):
        ...
        ##Inventory (only do it once!)
        if not self.inventory_calc_done:
            ...
            #label inventory calculation as 'done'
            self.inventory_calc_done=True
        else: print ("inventory calculation has been performed!")
        ...
        *self.TEA_input_wb.sheets['Financial param'].range('I5').value/100
        ...
        ##Min sales price
        self.total_fixed_cost=[-interest-(self.total_pay_cost+self.total_other_cost+self.annual_depreciation \
                               +self.amortized_setup_cost) for interest in self.interest_expense] #starts at yr1     
    ...
    def update_cells(self,sht_cel_new_val_dict):
        ...
        ============================================
        """
        ##create a nested dict of {sht_name: [{cel_range_1:new_vals_1},{cel_range_2:new_vals_2}..]}
